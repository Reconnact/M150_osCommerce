...
define('TEXT_PRODUCTS_WIDTH_INFO', 'Width:');
define('TEXT_PRODUCTS_HEIGHT_INFO', 'Height:');
define('TEXT_PRODUCTS_LENGTH_INFO', 'Length:');
define('TEXT_PRODUCTS_WEIGHT_INFO', 'Weight:');
